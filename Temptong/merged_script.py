...
class FlightSearch:
    ...
    def search_flights(self, origin_code, destination_code, departure_date, return_date, adults):
...
class HotelSearch:
    ...
    def fetch_hotel_list(self, destination_code, check_in_date, check_out_date, adults):
        destination_city = destination_var.get()
