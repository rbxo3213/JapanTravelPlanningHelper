...
def display_flight_details(flight_data):
    ...
    new_window.geometry("860x300")  # 창 크기 조정
...
# Add a variable for the number of adults
adults_var = tk.IntVar(value=1)  # Default value

# Modify the UI to include the number of adults selection
...
# Modify the flight search button to search for both flights and hotels
